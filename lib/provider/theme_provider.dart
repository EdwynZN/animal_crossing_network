...
class ThemeProvider with ChangeNotifier{
  ThemeMode _preferredTheme = ThemeMode.system;

  ThemeProvider();

  ThemeMode get mode => _preferredTheme;

  Future<void> themePreference(ThemeMode value) async {
    if(value == null) value = ThemeMode.system;
    if(value != _preferredTheme){
...
class _Themes{
  ...
  static final ThemeData animalCrossingTheme = ThemeData(
    ...
    appBarTheme: AppBarTheme(
      ...
      textTheme: TextTheme(
        title: TextStyle(color: Colors.white, fontSize: 20, fontFamily: 'Nintender',),
        subtitle: TextStyle(color: Colors.white, fontSize: 16, fontFamily: 'Nintender',),
      ),
